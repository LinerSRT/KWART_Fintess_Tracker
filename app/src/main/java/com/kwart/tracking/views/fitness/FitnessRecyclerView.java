...
public class FitnessRecyclerView extends FitnessRecycler{
    ...
    public FitnessRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public void initLayoutManager(int orientation, boolean reverse){
        mPageLayoutManager = new PageLayoutManager(getContext(), orientation, reverse);
    ...
    public class PageLayoutManager extends LinearLayoutManager {
        ...
        public void scrollToPosition(int position) {
            if(getAdapter() == null || !(getAdapter() instanceof FitnessTypeRecyclerAdapter)){
                super.scrollToPosition(position);
                return;
            }

            final FitnessTypeRecyclerAdapter adapter = (FitnessTypeRecyclerAdapter) getAdapter();
    ...
    public int getCurrentItem(){
        return mPageLayoutManager.findFirstVisibleItemPosition();
    }
